...
const Calcite = (
    e = (
        A = 0.35859695,
        B = (0.82427380, 0.14429128, 0.0),
        C = (1.06689543 * 1e-2, 120.0, 0.0),
    ),
    o = (
        A = 0.73358749,
        B = (0.96464345, 1.82831454, 0.0),
        C = (1.94325203 * 1e-2, 120.0, 0.0),
    ),
    range = (0.204, 2.172),
)
...
const Quartz = (
    e = (
        A = 0.28851804,
        B = (1.09509924, 1.15662475, 0.0),
        C = (1.02101864 * 1e-2, 100.0, 0.0),
    ),
    o = (
        A = 0.28604141,
        B = (1.07044083, 1.10202242, 0.0),
        C = (1.00585997 * 1e-2, 100.0, 0.0),
    ),
    range = (0.198, 2.0531),
)
